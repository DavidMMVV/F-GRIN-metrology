...
if __name__ == "__main__":
    ...
    prop_shape = jnp.array((16,128,128))
    prop_pix_sizes = jnp.array((l/4, l, l))
    ...
    im2 = sub[1].imshow(eps_original[:,:,eps_original.shape[1]//2].T, extent=ext_obj_zy, aspect=0.05)
    im3 = sub[2].imshow(eps_original[:,eps_original.shape[2]//2].T, extent=ext_obj_zx, aspect=0.05)
    ...
    fig, sub = plt.subplots(1,3)
    im1 = sub[0].imshow(eps_original[eps_original.shape[0]//2], extent=ext_obj_xy, aspect=1)
    im2 = sub[1].imshow(eps_original[:,:,eps_original.shape[1]//2].T, extent=ext_obj_zy, aspect=0.25)
    im3 = sub[2].imshow(eps_original[:,eps_original.shape[2]//2].T, extent=ext_obj_zx, aspect=0.25)
    plt.colorbar(im1, ax=sub[0])
    plt.colorbar(im2, ax=sub[1])
    plt.colorbar(im3, ax=sub[2])
    sub[0].set_title("Epsilon slice XY")
    ...
    im2 = sub[1].imshow(guess[:,:,eps_original.shape[1]//2].T, extent=ext_obj_zy, aspect=0.25)
    im3 = sub[2].imshow(guess[:,eps_original.shape[2]//2].T, extent=ext_obj_zx, aspect=0.25)
    plt.colorbar(im1, ax=sub[0])
    plt.colorbar(im2, ax=sub[1])
    plt.colorbar(im3, ax=sub[2])
    sub[0].set_title("Epsilon slice XY")
